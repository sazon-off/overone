...
class Deposit(Bank):
    def __init__(self, name, currency, annual_interest_rate, max_sum, min_sum, bank_name=None):
...
d = Deposit('Годовой', 'euro', 10, 2000, 100)
d1 = Deposit('Быстрый', 'euro', 8, 1000, 50, 'alfa')
d2 = Deposit('Легкий', 'euro', 5, 1000, 50, 'alfa')
d.info()
d.finance_calc(1000, 2)
c = Credit('Выгодный', 'euro', 20, 10)
c.info_credit()
c.fin_calc(100, 1)
b = Bank('Prior')
b.add_dep(d)
